...
|---|---|---|
| Xcode → target **JalanKita Mac** & **JalanKita iOS** → Signing & Capabilities → Team | `S3AP74B5TH` | Team ID kamu |
| Bundle Identifier kedua target | `com.biru.JalanKita-Mac` / `com.biru.JalanKita-iOS` | domain kamu |
| `JalanKita Mac/JalanKita Mac/JalanKita Mac.entitlements`<br>`JalanKita Mac/JalanKita iOS/JalanKita iOS.entitlements` | `iCloud.com.biru.JalanKita` | kontainer iCloud kamu |
| `JalanKitaKit/Sources/JalanKitaKit/CloudKit/CloudKitSchema.swift` → `containerIdentifier` | `iCloud.com.biru.JalanKita` | kontainer iCloud kamu (**harus sama persis** dengan entitlements di atas) |
